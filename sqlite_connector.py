...
class Approvalrequest(Base):
    ...
    resolution: sqlalchemy.orm.Mapped[typing.Optional[str]] = sqlalchemy.orm.mapped_column()
    requestType: sqlalchemy.orm.Mapped[typing.Optional[int]] = sqlalchemy.orm.mapped_column()
    createdBy: sqlalchemy.orm.Mapped[typing.Optional[str]] = sqlalchemy.orm.mapped_column()
    requestorComments: sqlalchemy.orm.Mapped[typing.Optional[str]] = sqlalchemy.orm.mapped_column()
    requestorEmail: sqlalchemy.orm.Mapped[typing.Optional[str]] = sqlalchemy.orm.mapped_column()
    priority: sqlalchemy.orm.Mapped[typing.Optional[str]] = sqlalchemy.orm.mapped_column()
    resolutionComments: sqlalchemy.orm.Mapped[typing.Optional[str]] = sqlalchemy.orm.mapped_column()
    status: sqlalchemy.orm.Mapped[typing.Optional[int]] = sqlalchemy.orm.mapped_column()
    policyId: sqlalchemy.orm.Mapped[typing.Optional[int]] = sqlalchemy.orm.mapped_column()
    multipleBlocks: sqlalchemy.orm.Mapped[typing.Optional[bool]] = sqlalchemy.orm.mapped_column()
    ...
    duplicates: sqlalchemy.orm.Mapped[typing.Optional[int]] = sqlalchemy.orm.mapped_column()
    related: sqlalchemy.orm.Mapped[typing.Optional[str]] = sqlalchemy.orm.mapped_column()
    platform: sqlalchemy.orm.Mapped[typing.Optional[str]] = sqlalchemy.orm.mapped_column()
    publisherReputation: sqlalchemy.orm.Mapped[typing.Optional[str]] = sqlalchemy.orm.mapped_column()
    customRuleType: sqlalchemy.orm.Mapped[typing.Optional[str]] = sqlalchemy.orm.mapped_column()
    installer: sqlalchemy.orm.Mapped[typing.Optional[str]] = sqlalchemy.orm.mapped_column()
    processName: sqlalchemy.orm.Mapped[typing.Optional[str]] = sqlalchemy.orm.mapped_column()
    processPath: sqlalchemy.orm.Mapped[typing.Optional[str]] = sqlalchemy.orm.mapped_column()
    responseMailSent: sqlalchemy.orm.Mapped[typing.Optional[str]] = sqlalchemy.orm.mapped_column()
    file: sqlalchemy.orm.Mapped[typing.Optional[str]] = sqlalchemy.orm.mapped_column()
...
class Newest_Event(Base):
    __tablename__ = "newest_event"
    id: sqlalchemy.orm.Mapped[typing.Optional[int]] = sqlalchemy.orm.mapped_column(primary_key=True)
    computerId: sqlalchemy.orm.Mapped[typing.Optional[int]] = sqlalchemy.orm.mapped_column()
    fileCatalogId: sqlalchemy.orm.Mapped[typing.Optional[int]] = sqlalchemy.orm.mapped_column()
    installerFileCatalogId: sqlalchemy.orm.Mapped[typing.Optional[int]] = sqlalchemy.orm.mapped_column()
